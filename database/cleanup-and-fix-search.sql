-- 1. Delete the unused general_embeddings table
DROP TABLE IF EXISTS general_embeddings CASCADE;

-- 2. Create the correct similarity search function based on actual schema
